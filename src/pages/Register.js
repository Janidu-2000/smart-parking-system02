      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#fff', minWidth: 0, padding: isMobile ? 16 : 32 }}>
        <div style={{ width: '100%', maxWidth: 400, margin: '0 auto' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: isMobile ? 20 : 32 }}>
            <ParkingLogo />
            <h1 style={{ fontWeight: 700, fontSize: isMobile ? 24 : 32, margin: isMobile ? '24px 0 8px 0' : '32px 0 8px 0', color: '#111' }}>Create your account</h1>
          </div>
          {error && (
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 12 : 18 }}>
              <div>
                <label style={{ fontWeight: 500, color: '#222', marginBottom: 6, display: 'block' }}>Name</label>
                <input
                  type="text"
                  value={name}
          ...
          <div style={{ marginTop: 16, fontSize: isMobile ? 14 : 15, color: '#6b7280', textAlign: 'center' }}>
