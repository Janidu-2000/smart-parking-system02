  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        {isSlot && <Input label="Price per Hour (Lkr)" type="number" step="0.01" value={element.meta.price || 0} onChange={(v) => updateMeta(element.id, { price: Number(v) })} isMobile={isMobile} />}
